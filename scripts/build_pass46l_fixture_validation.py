#!/usr/bin/env python3
"""PASS 46L (Part G) — planner fixture tests (per-context policies + honesty).
...
the two report files. Writes data/experiments/pass46l_planner_fixture_validation.{json,md}.
Exit 0 iff all_ok.
"""
...
from ptcg_activegraph.analysis import diamond_specialist_v1 as ds
...
def main() -> int:
    ...
    data = {"pass": "46l", "part": "G", "read_only": True, "local_only": True,
    ...
    (EXP / "pass46l_planner_fixture_validation.json").write_text(
        json.dumps(data, indent=2, default=str) + "\n", encoding="utf-8")

    md = [
        "# PASS 46L · Part G — planner fixture tests", "",
    ...
    (EXP / "pass46l_planner_fixture_validation.md").write_text("\n".join(md) + "\n",
                                                               encoding="utf-8")
