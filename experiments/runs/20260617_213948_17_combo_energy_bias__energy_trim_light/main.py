...
# === EXPERIMENT OVERRIDE: combo_energy_bias__energy_trim_light (seam=combo.energy_priority_trim) ===
_OPTION_TYPE_SCORES.update({8: 28})
_POSITIVE.update({'attach': 85, 'energy': 85})
# === END OVERRIDE ===
