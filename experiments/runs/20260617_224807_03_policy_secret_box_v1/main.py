...
# === EXPERIMENT OVERRIDE: policy_secret_box_v1 (seam=policy.secret_box_mode_selection) ===
_POSITIVE.update({'secret box': 85, 'ultra ball': 55, 'mega signal': 50, 'lillie': 45, 'powerglass': 35, 'surfing beach': 30})
# === END OVERRIDE ===
