...
# === EXPERIMENT OVERRIDE: policy_attach_targeting_v1 (seam=policy.attach_targeting) ===
_OPTION_TYPE_SCORES.update({8: 30})
_POSITIVE.update({'attach': 70, 'energy': 55, 'active': 30})
# === END OVERRIDE ===
