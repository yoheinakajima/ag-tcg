...
# === EXPERIMENT OVERRIDE: policy_setup_hybrid (seam=policy.setup_active_choice) ===
# (no overrides: exact v1 control copy)
# === END OVERRIDE ===



# === PASS5 BOARD-AWARE OVERRIDE: policy_setup_hybrid (seam=policy.setup_active_choice) ===
...
_P5_RULES = {'setup_contexts': [1, 2], 'setup_prefer_ids': [722, 721], 'setup_prefer_weight': 60}
