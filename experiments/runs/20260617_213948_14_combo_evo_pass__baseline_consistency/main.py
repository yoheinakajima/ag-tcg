...
# === EXPERIMENT OVERRIDE: combo_evo_pass__baseline_consistency (seam=combo.evolution_pass_consistency) ===
_OPTION_TYPE_SCORES.update({14: -160})
_POSITIVE.update({'evolve': 95, 'evolution': 90})
_NEGATIVE.update({'pass': -260, 'end': -260, 'done': -220})
# === END OVERRIDE ===
