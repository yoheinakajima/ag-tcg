...
# === EXPERIMENT OVERRIDE: combo_evo_attack__baseline_consistency (seam=combo.evolution_attack_consistency) ===
_OPTION_TYPE_SCORES.update({13: 220, 14: -90})
_ATTACK_ID_BONUS = 70
_POSITIVE.update({'evolve': 95, 'evolution': 90, 'attack': 140, 'knockout': 170, 'knock': 150})
# === END OVERRIDE ===
