...
# === EXPERIMENT OVERRIDE: combo_full_v3 (seam=combo.full_v3) ===
_OPTION_TYPE_SCORES.update({8: 40})
_POSITIVE.update({'attach': 90, 'energy': 70, 'active': 35})
# === END OVERRIDE ===



# === PASS5 BOARD-AWARE OVERRIDE: combo_full_v3 (seam=combo.full_v3) ===
...
# === PASS6 DECLINE OVERRIDE: combo_full_v3 (seam=combo.full_v3) ===
