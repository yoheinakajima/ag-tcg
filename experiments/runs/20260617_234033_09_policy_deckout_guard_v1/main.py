...
# === EXPERIMENT OVERRIDE: policy_deckout_guard_v1 (seam=policy.deckout_awareness) ===
# (no overrides: exact v1 control copy)
# === END OVERRIDE ===



# === PASS5 BOARD-AWARE OVERRIDE: policy_deckout_guard_v1 (seam=policy.deckout_awareness) ===
