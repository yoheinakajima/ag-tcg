...
# === EXPERIMENT OVERRIDE: combo_setup_evo__energy_trim_medium (seam=combo.setup_archetype_trim) ===
_OPTION_TYPE_SCORES.update({8: 24})
_POSITIVE.update({'evolve': 90, 'evolution': 85, 'attach': 75, 'energy': 75})
# === END OVERRIDE ===
