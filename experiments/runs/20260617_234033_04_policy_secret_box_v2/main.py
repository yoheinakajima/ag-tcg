...
# === EXPERIMENT OVERRIDE: policy_secret_box_v2 (seam=policy.secret_box_mode_selection) ===
# (no overrides: exact v1 control copy)
# === END OVERRIDE ===



# === PASS5 BOARD-AWARE OVERRIDE: policy_secret_box_v2 (seam=policy.secret_box_mode_selection) ===
...
_P5_RULES = {'discard_avoid_ids': [722, 723, 721], 'discard_avoid_weight': -400, 'discard_prefer_ids': [3], 'discard_prefer_weight': 150, 'search_prefer_ids': [1121, 1145, 722, 723, 721], 'search_prefer_weight': 85}
