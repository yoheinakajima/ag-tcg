...
# === EXPERIMENT OVERRIDE: policy_effect_resolution_v1 (seam=policy.effect_resolution_targeting) ===
_POSITIVE.update({'ultra ball': 70, 'mega signal': 60, 'secret box': 60, 'lillie': 55, 'abomasnow': 50, 'kyogre': 45, 'snover': 45, 'powerglass': 35})
# === END OVERRIDE ===
