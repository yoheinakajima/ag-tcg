...
# === EXPERIMENT OVERRIDE: combo_effect_resolution_v3__secret_box_safety (seam=combo.effect_resolution_secret_box) ===
# (no overrides: exact v1 control copy)
# === END OVERRIDE ===



# === PASS5 BOARD-AWARE OVERRIDE: combo_effect_resolution_v3__secret_box_safety (seam=combo.effect_resolution_secret_box) ===
...
_P5_RULES = {'discard_avoid_ids': [722, 723, 721], 'discard_avoid_weight': -400, 'discard_prefer_ids': [3], 'discard_prefer_weight': 150, 'search_prefer_ids': [722, 723, 721, 1121, 1145, 1092], 'search_prefer_weight': 90, 'search_snover_before_mega': True, 'snover_first_bonus': 70, 'mega_without_snover_penalty': -70}
...
# === PASS6 DECLINE OVERRIDE: combo_effect_resolution_v3__secret_box_safety (seam=combo.effect_resolution_secret_box) ===
...
_P6_RULES = {'decline_mega_signal_no_snover': True}
