...
# === EXPERIMENT OVERRIDE: policy_mega_signal_v2 (seam=policy.mega_signal_evolution_search) ===
# (no overrides: exact v1 control copy)
# === END OVERRIDE ===



# === PASS5 BOARD-AWARE OVERRIDE: policy_mega_signal_v2 (seam=policy.mega_signal_evolution_search) ===
...
_P5_RULES = {'search_prefer_ids': [722, 723], 'search_prefer_weight': 60, 'search_snover_before_mega': True, 'snover_first_bonus': 90, 'mega_without_snover_penalty': -120}
