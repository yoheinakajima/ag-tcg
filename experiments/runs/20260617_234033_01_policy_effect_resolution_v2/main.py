...
# === EXPERIMENT OVERRIDE: policy_effect_resolution_v2 (seam=policy.effect_resolution_targeting) ===
# (no overrides: exact v1 control copy)
# === END OVERRIDE ===



# === PASS5 BOARD-AWARE OVERRIDE: policy_effect_resolution_v2 (seam=policy.effect_resolution_targeting) ===
...
_P5_RULES = {'discard_avoid_ids': [722, 723, 721], 'discard_avoid_weight': -300, 'discard_prefer_ids': [3], 'discard_prefer_weight': 150, 'search_prefer_ids': [722, 723, 721, 1121, 1145, 1092], 'search_prefer_weight': 90}
