...
# === EXPERIMENT OVERRIDE: policy_effect_resolution_v3 (seam=policy.effect_resolution_targeting) ===
# (no overrides: exact v1 control copy)
# === END OVERRIDE ===



# === PASS5 BOARD-AWARE OVERRIDE: policy_effect_resolution_v3 (seam=policy.effect_resolution_targeting) ===
...
_P5_RULES = {'discard_avoid_ids': [722, 723, 721], 'discard_avoid_weight': -300, 'discard_prefer_ids': [3], 'discard_prefer_weight': 150, 'search_prefer_ids': [722, 723, 721, 1121, 1145, 1092], 'search_prefer_weight': 90, 'search_snover_before_mega': True, 'snover_first_bonus': 70, 'mega_without_snover_penalty': -70}
...
# === PASS6 DECLINE OVERRIDE: policy_effect_resolution_v3 (seam=policy.effect_resolution_targeting) ===
