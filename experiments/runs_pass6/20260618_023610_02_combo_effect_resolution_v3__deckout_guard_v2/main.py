...
# === EXPERIMENT OVERRIDE: combo_effect_resolution_v3__deckout_guard_v2 (seam=combo.effect_resolution_deckout) ===
# (no overrides: exact v1 control copy)
# === END OVERRIDE ===



# === PASS5 BOARD-AWARE OVERRIDE: combo_effect_resolution_v3__deckout_guard_v2 (seam=combo.effect_resolution_deckout) ===
...
_P5_RULES = {'discard_avoid_ids': [722, 723, 721], 'discard_avoid_weight': -300, 'discard_prefer_ids': [3], 'discard_prefer_weight': 150, 'search_prefer_ids': [722, 723, 721, 1121, 1145, 1092], 'search_prefer_weight': 90, 'search_snover_before_mega': True, 'snover_first_bonus': 70, 'mega_without_snover_penalty': -70, 'deckout_threshold': 8, 'deckout_search_penalty': -180}
...
# === PASS6 DECLINE OVERRIDE: combo_effect_resolution_v3__deckout_guard_v2 (seam=combo.effect_resolution_deckout) ===
...
_P6_RULES = {'decline_mega_signal_no_snover': True, 'deckout_decline_threshold': 8}
