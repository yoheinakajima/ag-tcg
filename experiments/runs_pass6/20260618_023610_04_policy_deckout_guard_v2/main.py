...
# === EXPERIMENT OVERRIDE: policy_deckout_guard_v2 (seam=policy.deckout_awareness) ===
# (no overrides: exact v1 control copy)
# === END OVERRIDE ===



# === PASS5 BOARD-AWARE OVERRIDE: policy_deckout_guard_v2 (seam=policy.deckout_awareness) ===
...
_P5_RULES = {'deckout_threshold': 8, 'deckout_search_penalty': -180}
...
# === PASS6 DECLINE OVERRIDE: policy_deckout_guard_v2 (seam=policy.deckout_awareness) ===
...
_P6_RULES = {'deckout_decline_threshold': 8}
