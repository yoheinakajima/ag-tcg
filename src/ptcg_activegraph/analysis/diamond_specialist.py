"""PASS 46J — Diamond cg_typed SPECIALIST TURN PLANNER v0 (pure / never-raise).
...
* **Self-contained INLINE region** — the code between ``INLINE_DIAMOND_SPECIALIST_V0_BEGIN``
  / ``INLINE_DIAMOND_SPECIALIST_V0_END`` is pure-builtin (no annotations, no third-party or
...
INLINE_BEGIN_MARKER = "# ================== INLINE_DIAMOND_SPECIALIST_V0_BEGIN =================="
INLINE_END_MARKER = "# ================== INLINE_DIAMOND_SPECIALIST_V0_END =================="
