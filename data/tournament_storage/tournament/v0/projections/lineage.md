# Lineage (parent → child by family)

_Internal self-play diagnostics only. NOT a Kaggle leaderboard and NOT predictive of leaderboard placement. NO upload._

## diamond  (best-with-games: diamond_toolbox_diancie)
- gen0 `diamond_toolbox_diancie` (parent: —, status: portfolio_anchor)

## dragapult  (best-with-games: league_dragapult_spread)
- gen0 `league_dragapult_spread` (parent: —, status: active)
- gen1 `league_dragapult_v1_search_only` (parent: league_dragapult_spread, status: portfolio_anchor)

## durant  (best-with-games: n/a)
- gen0 `deckout_carousel_durant_v2` (parent: —, status: special_pilot_only)
...
- gen1 `water_basic_density_v1` (parent: league_water_core_reference, status: held_probe)
