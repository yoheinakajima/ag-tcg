...
# === PASS14 CORE-PILOT OVERRIDE: core_pilot_water_v3_context ===
...
_CP_PLAYBOOK = {'roles': {'basic_energy': [3], 'primary_basic_attacker': [721], 'setup_basic': [722], 'evolution_payoff': [723], 'search_cards': [1121, 1145], 'high_risk_search': [1092], 'tools': [1163], 'draw_support': [1219, 1227, 1262], 'stadium': [1262]}, 'plan': {'primary_plan': 'kyogre_tempo', 'secondary_plan': 'abomasnow_evolution', 'avoid_plans': ['passive_draw_loop', 'deckout']}, 'deckout_guard_thresholds': {'penalize': 8, 'heavy': 4, 'critical': 2}, 'role_weights': {'active_prefers': ['primary_basic_attacker'], 'bench_prefers': ['primary_basic_attacker', 'setup_basic'], 'attach_prefers': ['active_attacker', 'next_attacker'], 'search_prefers': 'missing_plan_piece', 'discard_prefers': ['basic_energy'], 'preserve_only': ['setup_basic', 'primary_basic_attacker', 'evolution_payoff_when_setup_exists']}, 'exceptions': {'secret_box': {'min_safe_discards': 3, 'play_safety': 'advisory', 'forced_discard_all_is_failure': False}, 'ultra_ball': {'discard_excess_energy_first': True, 'fetch_missing_basic_before_orphan_evolution': True}, 'mega_signal': {'require_setup_basic_in_play': True}}}
