...
_EMBEDDED_DECK = [
    4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
    4, 4, 4, 4, 4, 4, 4, 4, 4, 4,
    4, 4, 4, 4, 4, 4, 514, 514, 809, 809,
    809, 810, 811, 811, 811, 957, 957, 957, 957, 1079,
    1079, 1079, 1086, 1086, 1086, 1086, 1121, 1121, 1121, 1121,
...
# === PASS35 TYPED STRATEGY OVERRIDE: mono_lightning_miraidon_easy_typed35 ===
...
_TP_PROFILE = {'id': 'mono_lightning_miraidon_easy', 'executable': True, 'lane': 'stdlib_typed_lite', 'implemented_contexts': [0, 1, 2, 7, 8, 38], 'unsupported_mechanics': ['attack_damage', 'lethal', 'ko_targeting', 'spread', 'boss', 'gust', 'opponent_hand'], 'roles': {'primary_attacker': [957, 811], 'setup_basic': [957, 809, 514], 'key_item': [1079], 'draw_engine': [1224, 1231], 'search': [1121, 1086], 'tech': [810, 811, 1254], 'bench_sitter': [514]}, 'priority': [957, 809, 810, 811, 1079, 1121, 1086], 'energy_types': ['Lightning'], 'deckout_guard': {'min_deck': 2, 'max_draw': None}, 'discard_keep': [957, 811, 1079], 'discard_prefer': [4]}
_TP_META = {4: {'name': 'Basic {L} Energy', 'card_type': 'energy', 'is_basic_energy': True, 'energy_type': 'Lightning'}, 514: {'name': 'Thundurus', 'card_type': 'pokemon', 'stage': 'basic', 'is_basic_pokemon': True, 'energy_type': 'Lightning', 'hp': 120, 'retreat_cost': 1}, 809: {'name': 'Pawmi', 'card_type': 'pokemon', 'stage': 'basic', 'is_basic_pokemon': True, 'energy_type': 'Lightning', 'hp': 60, 'retreat_cost': 1}, 810: {'name': 'Pawmo', 'card_type': 'pokemon', 'stage': 'stage1', 'energy_type': 'Lightning', 'hp': 90, 'retreat_cost': 1}, 811: {'name': 'Pawmot', 'card_type': 'pokemon', 'stage': 'stage2', 'energy_type': 'Lightning', 'hp': 140, 'retreat_cost': 1}, 957: {'name': 'Miraidon ex', 'card_type': 'pokemon', 'stage': 'basic', 'is_basic_pokemon': True, 'energy_type': 'Lightning', 'hp': 220, 'retreat_cost': 1, 'ex': True}, 1079: {'name': 'Rare Candy', 'card_type': 'trainer'}, 1086: {'name': 'Buddy-Buddy Poffin', 'card_type': 'trainer'}, 1121: {'name': 'Ultra Ball', 'card_type': 'trainer'}, 1224: {'name': 'Cheren', 'card_type': 'trainer'}, 1231: {'name': 'Dawn', 'card_type': 'trainer'}, 1254: {'name': 'Levincia', 'card_type': 'trainer'}}
