...
# === PASS14 CORE-PILOT OVERRIDE: league_water_core_reference ===
...
# === PASS35 TYPED STRATEGY OVERRIDE: water_core_reference_typed35 ===
...
_TP_PROFILE = {'id': 'water_core_reference', 'executable': True, 'lane': 'stdlib_typed_lite', 'implemented_contexts': [7, 8], 'unsupported_mechanics': ['attack_damage', 'lethal', 'ko_targeting', 'spread', 'boss', 'gust', 'opponent_hand'], 'roles': {'primary_attacker': [721, 723], 'setup_basic': [722, 721], 'draw_engine': [1219, 1227], 'search': [1121, 1145, 1092], 'key_item': [1163], 'tech': [1262]}, 'priority': [721, 723, 722, 1121, 1145], 'energy_types': ['Water'], 'deckout_guard': {'min_deck': 2, 'max_draw': None}, 'discard_keep': [721, 722, 723, 1163], 'discard_prefer': [3]}
_TP_META = {3: {'name': 'Basic {W} Energy', 'card_type': 'energy', 'is_basic_energy': True, 'energy_type': 'Water'}, 721: {'name': 'Kyogre', 'card_type': 'pokemon', 'stage': 'basic', 'is_basic_pokemon': True, 'energy_type': 'Water', 'hp': 150, 'retreat_cost': 3}, 722: {'name': 'Snover', 'card_type': 'pokemon', 'stage': 'basic', 'is_basic_pokemon': True, 'energy_type': 'Water', 'hp': 90, 'retreat_cost': 3}, 723: {'name': 'Mega Abomasnow ex', 'card_type': 'pokemon', 'stage': 'stage1', 'energy_type': 'Water', 'hp': 350, 'retreat_cost': 4, 'ex': True}, 1092: {'name': 'Secret Box', 'card_type': 'trainer'}, 1121: {'name': 'Ultra Ball', 'card_type': 'trainer'}, 1145: {'name': 'Mega Signal', 'card_type': 'trainer'}, 1163: {'name': 'Powerglass', 'card_type': 'trainer'}, 1219: {'name': "Team Rocket's Petrel", 'card_type': 'trainer'}, 1227: {'name': "Lillie's Determination", 'card_type': 'trainer'}, 1262: {'name': 'Surfing Beach', 'card_type': 'trainer'}}
_TP_RUNTIME_CONTEXTS = (7, 8)
