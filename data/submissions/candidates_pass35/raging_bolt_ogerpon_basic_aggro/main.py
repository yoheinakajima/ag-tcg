...
_EMBEDDED_DECK = [
    1, 1, 1, 4, 4, 4, 4, 4, 4, 4,
    4, 6, 6, 6, 6, 6, 6, 6, 6, 6,
    6, 6, 6, 6, 63, 63, 63, 63, 96, 96,
    96, 96, 1086, 1086, 1086, 1086, 1097, 1097, 1097, 1097,
    1121, 1121, 1121, 1121, 1182, 1182, 1182, 1182, 1198, 1198,
    1198, 1198, 1224, 1224, 1224, 1224, 1231, 1231, 1231, 1231,
]
...
# === PASS14 CORE-PILOT OVERRIDE: league_raging_bolt_ogerpon ===
...
_CP_PLAYBOOK = {'roles': {'basic_energy': [6, 4, 1], 'primary_basic_attacker': [63], 'secondary_attacker': [96], 'setup_basic': [63, 96], 'search': [1121, 1086, 1198], 'draw': [1224, 1231], 'energy': [6, 4, 1], 'energy_search': [1198], 'disruption': [1182], 'recovery': [1097]}, 'plan': {'primary_plan': 'raging_bolt_aggro', 'secondary_plan': 'ogerpon_pressure', 'avoid_plans': ['deckout', 'passive_draw_loop']}, 'deckout_guard_thresholds': {'penalize': 8, 'heavy': 4, 'critical': 2}, 'role_weights': {'active_prefers': ['primary_basic_attacker', 'secondary_attacker'], 'bench_prefers': ['primary_basic_attacker', 'secondary_attacker'], 'attach_prefers': ['active_attacker', 'next_attacker'], 'search_prefers': 'missing_plan_piece', 'discard_prefers': ['surplus_basic_energy'], 'preserve_only': ['primary_basic_attacker', 'secondary_attacker']}, 'exceptions': {}}
...
# === PASS35 TYPED STRATEGY OVERRIDE: raging_bolt_ogerpon_basic_aggro_typed35 ===
...
_TP_PROFILE = {'id': 'raging_bolt_ogerpon_basic_aggro', 'executable': True, 'lane': 'stdlib_typed_lite', 'implemented_contexts': [1, 2, 7, 8, 38], 'unsupported_mechanics': ['attack_damage', 'lethal', 'ko_targeting', 'spread', 'boss', 'gust', 'opponent_hand'], 'roles': {'primary_attacker': [63, 96], 'setup_basic': [63, 96], 'energy_accel': [1198], 'draw_engine': [1231, 1224], 'search': [1121, 1086], 'tech': [1097]}, 'priority': [63, 96, 1198, 1121, 1086], 'energy_types': ['Fighting', 'Lightning'], 'deckout_guard': {'min_deck': 2, 'max_draw': None}, 'discard_keep': [63, 96], 'discard_prefer': [1]}
_TP_META = {1: {'name': 'Basic {G} Energy', 'card_type': 'energy', 'is_basic_energy': True, 'energy_type': 'Grass'}, 63: {'name': 'Raging Bolt ex', 'card_type': 'pokemon', 'stage': 'basic', 'is_basic_pokemon': True, 'energy_type': '竜', 'hp': 240, 'retreat_cost': 3, 'ex': True}, 96: {'name': 'Teal Mask Ogerpon ex', 'card_type': 'pokemon', 'stage': 'basic', 'is_basic_pokemon': True, 'energy_type': 'Grass', 'hp': 210, 'retreat_cost': 1, 'ex': True}, 1086: {'name': 'Buddy-Buddy Poffin', 'card_type': 'trainer'}, 1097: {'name': 'Night Stretcher', 'card_type': 'trainer'}, 1121: {'name': 'Ultra Ball', 'card_type': 'trainer'}, 1198: {'name': 'Crispin', 'card_type': 'trainer'}, 1224: {'name': 'Cheren', 'card_type': 'trainer'}, 1231: {'name': 'Dawn', 'card_type': 'trainer'}}
_TP_RUNTIME_CONTEXTS = (1, 2, 7, 8, 38)
