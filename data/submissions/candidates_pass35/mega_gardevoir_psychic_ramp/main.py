...
_EMBEDDED_DECK = [
    ...
    747, 1079, 1079, 1079, 1079, 1086, 1086, 1086, 1086, 1097,
    1097, 1121, 1121, 1121, 1121, 1182, 1182, 1182, 1199, 1199,
    1213, 1213, 1224, 1224, 1224, 1224, 1231, 1231, 1231, 1231,
]
...
# === PASS14 CORE-PILOT OVERRIDE: league_mega_gardevoir_psychic_ramp ===
...
_CP_PLAYBOOK = {'roles': {'basic_energy': [5], 'setup_basic': [745], 'evolution_mid': [746], 'evolution_payoff': [747], 'evolution_accel': [1079], 'search': [1121, 1086], 'draw': [1231, 1224, 1199], 'energy': [5], 'disruption': [1182, 1213], 'recovery': [1097]}, 'plan': {'primary_plan': 'mega_gardevoir_psychic_ramp', 'secondary_plan': 'psychic_energy_accumulation', 'avoid_plans': ['deckout', 'orphan_evolution', 'premature_attack']}, 'deckout_guard_thresholds': {'penalize': 8, 'heavy': 4, 'critical': 2}, 'role_weights': {'active_prefers': ['evolution_payoff', 'setup_basic'], 'bench_prefers': ['setup_basic', 'evolution_mid', 'evolution_payoff'], 'attach_prefers': ['active_attacker', 'next_attacker'], 'search_prefers': 'missing_evolution_piece', 'discard_prefers': ['surplus_basic_energy'], 'preserve_only': ['setup_basic', 'evolution_mid', 'evolution_payoff_when_setup_exists']}, 'exceptions': {}}
...
# === PASS35 TYPED STRATEGY OVERRIDE: mega_gardevoir_psychic_ramp_typed35 ===
...
_TP_PROFILE = {'id': 'mega_gardevoir_psychic_ramp', 'executable': True, 'lane': 'stdlib_typed_lite', 'implemented_contexts': [0, 1, 2, 7, 8, 38], 'unsupported_mechanics': ['attack_damage', 'lethal', 'ko_targeting', 'spread', 'boss', 'gust', 'opponent_hand'], 'roles': {'primary_attacker': [747], 'setup_basic': [745], 'key_item': [1079], 'draw_engine': [1231, 1224, 1199, 1213], 'search': [1121, 1086], 'tech': [746, 1097]}, 'priority': [747, 745, 746, 1079, 1121, 1086], 'energy_types': ['Psychic'], 'deckout_guard': {'min_deck': 2, 'max_draw': None}, 'discard_keep': [747, 745, 1079], 'discard_prefer': [5]}
_TP_META = {5: {'name': 'Basic {P} Energy', 'card_type': 'energy', 'is_basic_energy': True, 'energy_type': 'Psychic'}, 745: {'name': 'Ralts', 'card_type': 'pokemon', 'stage': 'basic', 'is_basic_pokemon': True, 'energy_type': 'Psychic', 'hp': 70, 'retreat_cost': 1}, 746: {'name': 'Kirlia', 'card_type': 'pokemon', 'stage': 'stage1', 'energy_type': 'Psychic', 'hp': 100, 'retreat_cost': 1}, 747: {'name': 'Mega Gardevoir ex', 'card_type': 'pokemon', 'stage': 'stage2', 'energy_type': 'Psychic', 'hp': 360, 'retreat_cost': 2, 'ex': True}, 1079: {'name': 'Rare Candy', 'card_type': 'trainer'}, 1086: {'name': 'Buddy-Buddy Poffin', 'card_type': 'trainer'}, 1097: {'name': 'Night Stretcher', 'card_type': 'trainer'}, 1121: {'name': 'Ultra Ball', 'card_type': 'trainer'}, 1199: {'name': 'Lacey', 'card_type': 'trainer'}, 1213: {'name': 'Judge', 'card_type': 'trainer'}, 1224: {'name': 'Cheren', 'card_type': 'trainer'}, 1231: {'name': 'Dawn', 'card_type': 'trainer'}}
