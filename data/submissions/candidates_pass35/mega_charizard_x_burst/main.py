...
_EMBEDDED_DECK = [
    2, 2, 2, 2, 2, 2, 2, 2, 2, 2,
    2, 2, 2, 2, 2, 2, 2, 2, 788, 788,
    788, 788, 789, 789, 789, 790, 790, 790, 795, 795,
    1079, 1079, 1079, 1079, 1086, 1086, 1086, 1086, 1097, 1097,
    1121, 1121, 1121, 1121, 1182, 1182, 1182, 1198, 1198, 1198,
    1224, 1224, 1224, 1231, 1231, 1231, 1231, 1232, 1232, 1232,
]
...
# === PASS14 CORE-PILOT OVERRIDE: league_mega_charizard_x_burst ===
...
_CP_PLAYBOOK = {'roles': {'basic_energy': [2], 'setup_basic': [788, 795], 'evolution_mid': [789], 'evolution_payoff': [790], 'evolution_accel': [1079], 'energy_accel': [1232, 1198], 'search': [1121, 1086], 'draw': [1231, 1224], 'energy': [2], 'disruption': [1182], 'recovery': [1097]}, 'plan': {'primary_plan': 'mega_charizard_x_burst', 'secondary_plan': 'fire_energy_acceleration', 'avoid_plans': ['deckout', 'orphan_evolution', 'energy_starved_attack']}, 'deckout_guard_thresholds': {'penalize': 8, 'heavy': 4, 'critical': 2}, 'role_weights': {'active_prefers': ['evolution_payoff', 'setup_basic'], 'bench_prefers': ['setup_basic', 'evolution_mid', 'evolution_payoff'], 'attach_prefers': ['active_attacker', 'next_attacker'], 'search_prefers': 'missing_evolution_piece', 'discard_prefers': ['surplus_basic_energy'], 'preserve_only': ['setup_basic', 'evolution_mid', 'evolution_payoff_when_setup_exists']}, 'exceptions': {}}
...
# === PASS35 TYPED STRATEGY OVERRIDE: mega_charizard_x_burst_typed35 ===
...
_TP_PROFILE = {'id': 'mega_charizard_x_burst', 'executable': True, 'lane': 'stdlib_typed_lite', 'implemented_contexts': [0, 1, 2, 7, 8, 38], 'unsupported_mechanics': ['attack_damage', 'lethal', 'ko_targeting', 'spread', 'boss', 'gust', 'opponent_hand'], 'roles': {'primary_attacker': [790, 795], 'setup_basic': [788, 795], 'energy_accel': [1232, 1198], 'key_item': [1079], 'draw_engine': [1231, 1224], 'search': [1121, 1086], 'tech': [789, 1097]}, 'priority': [790, 788, 789, 1079, 1198, 1232, 1121, 1086], 'energy_types': ['Fire'], 'deckout_guard': {'min_deck': 2, 'max_draw': None}, 'discard_keep': [790, 788, 1079], 'discard_prefer': [2]}
_TP_META = {2: {'name': 'Basic {R} Energy', 'card_type': 'energy', 'is_basic_energy': True, 'energy_type': 'Fire'}, 788: {'name': 'Charmander', 'card_type': 'pokemon', 'stage': 'basic', 'is_basic_pokemon': True, 'energy_type': 'Fire', 'hp': 80, 'retreat_cost': 2}, 789: {'name': 'Charmeleon', 'card_type': 'pokemon', 'stage': 'stage1', 'energy_type': 'Fire', 'hp': 110, 'retreat_cost': 2}, 790: {'name': 'Mega Charizard X ex', 'card_type': 'pokemon', 'stage': 'stage2', 'energy_type': 'Fire', 'hp': 360, 'retreat_cost': 2, 'ex': True}, 795: {'name': 'Oricorio ex', 'card_type': 'pokemon', 'stage': 'basic', 'is_basic_pokemon': True, 'energy_type': 'Fire', 'hp': 190, 'retreat_cost': 1, 'ex': True}, 1079: {'name': 'Rare Candy', 'card_type': 'trainer'}, 1086: {'name': 'Buddy-Buddy Poffin', 'card_type': 'trainer'}, 1097: {'name': 'Night Stretcher', 'card_type': 'trainer'}, 1121: {'name': 'Ultra Ball', 'card_type': 'trainer'}, 1198: {'name': 'Crispin', 'card_type': 'trainer'}, 1224: {'name': 'Cheren', 'card_type': 'trainer'}, 1231: {'name': 'Dawn', 'card_type': 'trainer'}, 1232: {'name': 'Firebreather', 'card_type': 'trainer'}}
